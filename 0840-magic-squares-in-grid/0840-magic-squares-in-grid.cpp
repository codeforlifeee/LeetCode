...
public:
    ...
    private:
        bool isMagicSquare(vector<vector<int>>& grid, int row, int col){
            ...
            //check if all row sums are the same as teh diagonal sums
            ...
            if(!(row1 == diagonal1 && row2 == diagonal2 && row3 == diagonal1)){
                return false;
            }
            //check if all the column sums are the same as the diagonal sums
